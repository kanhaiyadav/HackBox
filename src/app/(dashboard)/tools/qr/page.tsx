                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div className="mb-6">
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    setContentType(
                                        e.target.value as QRContentType
                                    )
                                }
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div className="prose prose-sm text-gray-600">
                            ...
                            <ol className="list-decimal pl-5 space-y-2">
                                <li>
                                    Select the type of content you want to
                                    encode
                                </li>
                                <li>Fill in the required information</li>
                                <li>
                                    Customize the appearance with colors, size,
                                    and logo
                                </li>
                                <li>Download or copy your QR code</li>
                            </ol>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                <li>
                                    <strong>URL:</strong> Creates a QR code that
                                    opens a website
                                </li>
                                <li>
                                    <strong>Text:</strong> Encodes plain text
                                    that displays when scanned
                                </li>
                                <li>
                                    <strong>Contact:</strong> Generates a vCard
                                    QR code to save contact info
                                </li>
                                <li>
                                    <strong>WiFi:</strong> Creates a QR code
                                    that connects devices to WiFi
                                </li>
                                <li>
                                    <strong>SMS:</strong> QR code that pre-fills
                                    an SMS message
                                </li>
                                <li>
                                    <strong>Email:</strong> QR code that
                                    pre-fills an email
                                </li>
                            </ul>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                <li>
                                    Use higher error correction when adding a
                                    logo
                                </li>
                                <li>
                                ...
                                <li>
                                    For print materials, use at least 1cm
                                    (0.4in) size
                                </li>
                                <li>
                                    Dark colors work best for the QR code
                                    modules
                                </li>
                            </ul>
                        </div>
