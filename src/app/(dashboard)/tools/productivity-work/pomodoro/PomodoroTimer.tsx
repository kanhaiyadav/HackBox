...
export const PomodoroTimer: React.FC = () => {
    ...
    const [pomodorosUntilLongBreak, setPomodorosUntilLongBreak] =
        useState<number>(settings.longBreakInterval);
    ...
    const getBackgroundColor = () => {
        const themeColors = {
            default: {
                pomodoro: "from-red-500",
                shortBreak: "from-green-500",
                longBreak: "from-blue-500",
            },
            dark: {
                pomodoro: "from-red-900",
                shortBreak: "from-green-900",
                longBreak: "from-blue-900",
            },
            forest: {
                pomodoro: "from-orange-600",
                shortBreak: "from-emerald-600",
                longBreak: "from-teal-700",
            },
            ocean: {
                pomodoro: "from-pink-600",
                shortBreak: "from-cyan-600",
                longBreak: "from-indigo-700",
            },
        };
    ...
    return (
        <div
            className={`min-h-screen ${getBackgroundColor()} transition-colors duration-500`}
        >
            <div className="container mx-auto px-4 py-8">
                ...
                <main className="flex flex-col gap-8">
                    <div className={`bg-gradient-to-br ${getBackgroundColor()} to-background shadow-foreground bg-opacity-10 backdrop-blur-lg rounded-xl p-6 mb-6`}>
                    ...
                    <div className="flex">
                        ...
                        <div className="bg-background bg-opacity-10 backdrop-blur-lg rounded-xl p-6">
                            <h2
                                className={`text-xl font-bold mb-4 ${getTextColor()}`}
                            >
                                Session Stats
                            </h2>
                        ...
                        <div className="w-full md:w-1/3">
                            <div className="bg-background bg-opacity-10 backdrop-blur-lg rounded-xl p-6">
                                ...
                                <div className="space-y-2 max-h-96 overflow-y-auto custom-scrollbar">
                                    {taskList.length === 0 ? (
                                        <div
                                            className={`text-center py-4 ${getTextColor()} opacity-70`}
                                        >
                                            No tasks yet. Add some to get
                                            started!
                                        </div>
                                    ) : (
                                        taskList.map((task) => (
    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (type === "checkbox") {
            ...
            setTempSettings({
                ...tempSettings,
                [name]:
                    name.includes("Break") || name === "pomodoro"
